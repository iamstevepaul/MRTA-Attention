...
def get_options(args=None):
    ...
    parser.add_argument('--batch_size', type=int, default=400, help='Number of instances per batch during training') # changed
    parser.add_argument('--epoch_size', type=int, default=20000, help='Number of instances per epoch during training') # changed
